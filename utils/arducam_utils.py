...
class ArducamUtils(object):
    ...
    def __init__(self, device_num):
        try:
            ...
            print("jtop not available, using default pixel format map")
        except Exception as e:
            print(f"Error detecting Jetson hardware: {e}, using default pixel format map")
            
        import os
        self.vd = os.open('/dev/video{}'.format(device_num), os.O_RDWR)
        self.refresh()
